...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Font Awesome-->
    @includeIf('cms.layouts.admin.partials.css')
</head>
...
<body>
    ...
    <div class="page-wrapper compact-sidebar" id="pageWrapper">
        <!-- Page Header Start-->
        @includeIf('cms.layouts.admin.partials.header')
        <!-- Page Header Ends -->
        <!-- Page Body Start-->
        <div class="page-body-wrapper sidebar-icon">
            <!-- Page Sidebar Start-->
            @includeIf('cms.layouts.admin.partials.sidebar')
            <!-- Page Sidebar Ends-->
            <div class="page-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 footer-copyright">
                            <p class="mb-0">Copyright {{ date('Y') }}-{{ date('y', strtotime('+1 year')) }} ©
                                Neurona Fotográfica All Rights Reserved - Terms & Conditions</p>
                        </div>
                        <div class="col-md-6">
                            <p class="pull-right mb-0">Techies&Beyond </p>
                        </div>
                    </div>
                </div>
            </footer>
