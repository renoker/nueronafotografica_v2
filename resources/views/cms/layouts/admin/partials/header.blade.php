<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href=""><img class="img-fluid" src="{{ asset('assets/icons/logo.png') }}"
                        alt=""></a></div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown p-0">
                    <a href="{{ route('admin.logout') }}">
                        <button class="btn btn-primary-light" type="button"><i data-feather="log-out"></i>Cerrar
                            Sesión</button>
                    </a>
                </li>
            </ul>
