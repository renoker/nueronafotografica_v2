            ...
            <tr>
                <td>
                        ...
                        <tbody>
                            <tr class="header">
                                <td align="left" valign="top"><img class="main-logo"
                                        src="{{ asset('cms_assets/images/logo/logo.png') }}" /></td>
                        ...
                        <tbody>
                            <tr>
                                <th align="center" width="40%"><img
                                        src="{{ asset('cms_assets/images/email-template/slider.jpg') }}" alt=""
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img
                                                src="{{ asset('cms_assets/images/email-template/7.jpg') }}"
                                                alt="product" style="width: 100%;" /></div>
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img
                                                src="{{ asset('cms_assets/images/email-template/8.jpg') }}"
                                                alt="product" style="width: 100%;" /></div>
                                        <div class="product-info">
                            ...
                            <tr class="add-with-banner" align="center">
                                <td>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('cms_assets/images/email-template/banner.jpg') }}"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top: 30px;">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('cms_assets/images/email-template/banner-2.jpg') }}"
                                ...
                                <td align="center">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="width: 40%;"><img
                                                        src="{{ asset('cms_assets/images/email-template/10.jpg') }}"
                                    ...
                                    <table class="display-width-inner" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td align="center" style="width: 40%;"><img
                                                        src="{{ asset('cms_assets/images/email-template/11.jpg') }}"
                                                        alt="" style="width: 225px; margin-bottom: -4px;" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="display-width-inner" align="center" border="0" cellpadding="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" style="width: 40%;"><img
                                                        src="{{ asset('cms_assets/images/email-template/12.jpg') }}"
                                                        alt="" style="width: 225px; margin-bottom: -4px;" />
                                                </td>
                                                <td align="center" style="background-color: #fafafa; width: 60%;">
                                                    <h3 style="margin: 0;">Product One</h3>
