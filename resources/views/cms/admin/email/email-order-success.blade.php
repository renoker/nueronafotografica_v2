            ...
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('cms_assets/images/email-template/delivery.png') }}"
                                        alt="" style="margin-bottom: 30px;" /></td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <table class="order-detail" border="0" cellpadding="0" cellspacing="0" align="left">
                        <tbody>
                            ...
                            <tr>
                                <td><img src="{{ asset('cms_assets/images/email-template/4.png') }}" alt=""
                                        width="130" /></td>
                            ...
                            <tr>
                                <td><img src="{{ asset('cms_assets/images/email-template/1.png') }}" alt=""
                                        width="130" /></td>
                                <td valign="top" style="padding-left: 15px;">
                                    <h5 style="margin-top: 15px;">Three seater Wood Style sofa for Leavingroom</h5>
                                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="user-info" width="57" height="25"><img
                                        src="{{ asset('cms_assets/images/email-template/space.jpg') }}" alt=" "
