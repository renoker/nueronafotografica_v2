            ...
            <tr>
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tbody>
                            <tr>
                                <td><img src="{{ asset('cms_assets/images/email-template/1.jpg') }}" alt=""
                                        style="width: 100%;" /></td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img
                                                src="{{ asset('cms_assets/images/email-template/2.png') }}"
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="{{ asset('cms_assets/images/email-template/7.png') }}"
                                                alt="product" /></div>
                                        <div class="product-info">
                                ...
                                <td>
                                    <div class="product-box hover">
                                        <div class="product border-theme br-0"><img class="img-fluid"
                                                src="{{ asset('cms_assets/images/email-template/8.png') }}"
                                                alt="product" /></div>
                                        <div class="product-info">
                    ...
                    <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <tbody>
                            ...
                            <tr class="add-with-banner" align="center">
                                <td><img src="{{ asset('cms_assets/images/email-template/3.png') }}" /></td>
                                <td>
                            ...
                            <tr align="center">
                                <td>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('cms_assets/images/email-template/cosmetic.jpg') }}"
                                            style="width: 100%;" /></a>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 30px;">
                        <tbody>
                            <tr class="add-with-banner" align="center">
                                <td>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('cms_assets/images/email-template/6.png') }}"
                                            style="width: 100%;" /></a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)"><img
                                            src="{{ asset('cms_assets/images/email-template/5.png') }}"
                                            style="width: 100%;" /></a>
                                </td>
                            </tr>
                        </tbody>
