...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-5"><img class="bg-img-cover bg-center" src="{{ asset('cms_assets/images/login/3.jpg') }}"
                    alt="looginpage" /></div>
                    ...
                    <form class="theme-form login-form needs-validation" novalidate="">
                        ...
                        <div class="form-group">
                            <ul class="login-social">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/login" target="_blank"><i data-feather="instagram">
                                        </i></a>
                                </li>
                            </ul>
                        </div>
