	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.disabled</code> class or <code>disabled="disabled"</code> attribute for disabled
                            button</span>
                    </div>
                    <div class="card-body btn-showcase">
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>The <code>.btn</code> class used with <code>&lt;button&gt;</code>, <code>&lt;a&gt;</code> and
                            <code>&lt;input&gt;</code> elements.</span>
                    </div>
                    <div class="card-body btn-showcase">
                        <a class="btn btn-pill btn-primary" href="javascript:void(0)" data-bs-toggle="tooltip"
                            title="btn btn-primary" role="button">Link</a>
                        <input class="btn btn-pill btn-secondary" type="button" value="Input" data-bs-toggle="tooltip"
                            title="btn btn-secondary" />
                        <input class="btn btn-pill btn-success" type="submit" value="Submit" data-bs-toggle="tooltip"
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.btn-pill</code> and <code>.btn-outline-*</code> class for button with
                            outline</span>
                    </div>
                    <div class="card-body btn-showcase">
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.btn-pill</code> and <code>.btn-outline-*-2x</code> class for button with bold
                            outline</span>
                    </div>
                    <div class="card-body btn-showcase">
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-lg</code> class for
                            large button</span>
                    </div>
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-pill btn-outline-light btn-lg txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-sm</code> class for
                            small button</span>
                    </div>
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-pill btn-outline-light btn-sm txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
	...
	&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.btn-pill</code>,<code>.btn-outline-*</code> and <code>.btn-xs</code> class for
                    ...
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-pill btn-outline-light btn-xs txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
