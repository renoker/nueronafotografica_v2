...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body btn-showcase"><a class="btn btn-square btn-primary" href="javascript:void(0)"
                            data-bs-toggle="tooltip" title="btn btn-primary" role="button">Link</a>
                        <input class="btn btn-square btn-secondary" type="button" value="Input"
                            data-bs-toggle="tooltip" title="btn btn-secondary">
                        <input class="btn btn-square btn-success" type="submit" value="Submit" data-bs-toggle="tooltip"
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-square btn-outline-secondary btn-lg" type="button">Secondary
                            Button</button>
                        ...
                        <button class="btn btn-square btn-outline-light btn-lg txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-square btn-outline-secondary btn-sm" type="button">Secondary
                            Button</button>
                        ...
                        <button class="btn btn-square btn-outline-light btn-sm txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
...
&lt;!-- Cod Box Copy end --&gt;</code></pre>
                ...
                <div class="card">
                    ...
                    <div class="card-body btn-showcase">
                        ...
                        <button class="btn btn-square btn-outline-secondary btn-xs" type="button">Secondary
                            Button</button>
                        ...
                        <button class="btn btn-square btn-outline-light btn-xs txt-dark" type="button">Light
                            Button</button>
                        <div class="code-box-copy">
