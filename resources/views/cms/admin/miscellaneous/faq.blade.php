                                    ...
                                    <div class="card card-mb-faq">
                                        ...
                                        <div class="card-body faq-body">
                                            <div class="navigation-btn">
                                                <a class="btn btn-primary" href="javascript:void(0)"><i class="m-r-10"
                                                        data-feather="message-square"></i>Ask Question</a>
                                            </div>
                                            <div class="navigation-option">
                                                <ul>
                                                    <li>
                                                        <a href="javascript:void(0)"><i
                                                                data-feather="edit"></i>Tutorials</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"><i data-feather="globe"></i>Help
                                                            center</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"><i
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)"><i
                                                            ...
                                                            class="badge badge-primary badge-pill pull-right">42</span>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"><i data-feather="youtube"></i>Video
                                                            Tutorials</a><span
                                                            class="badge badge-primary badge-pill pull-right">648</span>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"><i
                                                                data-feather="message-circle"></i>Ask our community</a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)"><i data-feather="mail"></i>Contact us
                                                        </a>
                                                    </li>
                                                </ul>
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)"><i data-feather="mail"></i>Contact
                                                            us</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="card-body faq-body">
                                            <div class="media updates-faq-main">
                                                ...
                                                <div class="media-body updates-bottom-time">
                                                    <p><a href="javascript:void(0)">David Linner </a>requested money back
                                                        for a double debit card charge</p>
                                                    <p>10 minutes ago</p>
                                                </div>
                                            </div>
                                            <div class="media updates-faq-main">
                                            ...
                                            <div class="media updates-faq-main">
                                                ...
                                                <div class="media-body updates-bottom-time">
                                                    <p>User Christopher <a href="javascript:void(0)">Wallace</a> is on hold
                                                        and awaiting for staff reply</p>
                                                    <p>45 minutes ago</p>
                                                </div>
                                            </div>
                                            <div class="media updates-faq-main">
                                                ...
                                                <div class="media-body updates-bottom-time">
                                                    <p>Ticket #43683 has been closed by <a
