...
@push('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('cms_assets/css/summernote.css') }}">
@endpush
...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="summernote">
                            <p>
                                ...
                                ethics, very popular during the Renaissance. There are many variations of passages of Lorem
                                ...
                                free from repetition, injected humour, or non-characteristic words etc. Contrary to popular
                                ...
                                reasonable. The generated
                                Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic
                                words etc. Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
                                ...
                                theory of ethics, very popular during the Renaissance. There are many variations of passages
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <div class="inline-editor">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elitconsectetur adipisicing elit, sed do
                            ...
                            <ul class="list-icons">
                                ...
                                <li><i class="icofont icofont-heart-alt primary-color"></i> Integer molestie lorem at massa
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('cms_assets/js/editor/summernote/summernote.js') }}"></script>
        <script src="{{ asset('cms_assets/js/editor/summernote/summernote.custom.js') }}"></script>
