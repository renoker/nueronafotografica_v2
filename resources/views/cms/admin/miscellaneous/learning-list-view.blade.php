                                    ...
                                    <div class="blog-details">
                                        ...
                                        <div class="blog-bottom-content">
                                            ...
                                            <p class="mt-0">
                                                ...
                                                Nemo enim ipsam voluptatem quia voluptas sit.inventore veritatis et quasi
                                            ...
                                            <div class="card-body filter-cards-view animate-chk">
                                                ...
                                                <div class="checkbox-animated">
                                                    ...
                                                    <label class="d-block" for="chk-ani"> <input
                                                        ...
                                                        Accounting </label>
                                                    <label class="d-block" for="chk-ani0"> <input
                                                            class="checkbox_animated" id="chk-ani0" type="checkbox" />
                                                        Design </label>
                                                ...
                                                <div class="checkbox-animated mt-0">
                                                    ...
                                                    <label class="d-block" for="chk-ani6"> <input
                                                            class="checkbox_animated" id="chk-ani6" type="checkbox" />
                                                        0-50 hours </label>
                                                ...
                                                <div class="checkbox-animated mt-0">
                                                    ...
                                                    <label class="d-block" for="edo-ani"> <input class="radio_animated"
                                                            id="edo-ani" type="radio" name="rdo-ani"
                                                            checked="" /> All Courses </label>
                                                    <label class="d-block" for="edo-ani1"> <input class="radio_animated"
                                                            id="edo-ani1" type="radio" name="rdo-ani"
                                                            checked="" /> Paid Courses </label>
                                                    <label class="d-block" for="edo-ani2"> <input class="radio_animated"
                                                            id="edo-ani2" type="radio" name="rdo-ani"
                                                            checked="" /> Free Courses </label>
                                                </div>
                                                <div class="checkbox-animated mt-0">
