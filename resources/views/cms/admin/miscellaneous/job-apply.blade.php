                                        ...
                                        <div class="collapse show" id="collapseicon1" aria-labelledby="collapseicon1"
                                            ...
                                            <div class="card-body animate-chk">
                                                <div class="location-checkbox">
                                                    ...
                                                    <label class="d-block" for="chk-ani7"> <input
                                                            class="checkbox_animated" id="chk-ani7" type="checkbox" />
                                                        San Francisco<span class="d-block">CA (252)</span> </label>
                                                    <label class="d-block" for="chk-ani8"> <input
                                                            class="checkbox_animated" id="chk-ani8" type="checkbox" />
                                                        Washington<span class="d-block">DC (226)</span> </label>
                                                    <label class="d-block" for="chk-ani9"> <input
