...
@push('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('cms_assets/css/daterange-picker.css') }}">
@endpush
...
@section('content')
                ...
                <div class="row date-range-picker">
                    <div class="col-xl-6">
                        <div class="daterange-card">
                            ...
                            <p>The Date Range Picker use the current value of the input to initialize, and update the input
                                if new dates are chosen.</p>
                    ...
                    <div class="col-xl-6">
                        <div class="daterange-card">
                            ...
                            <p>This example shows the option to predefine date ranges that the user can choose from a list.
                            </p>
                            <div class="theme-form">
                                <div class="form-group">
                    ...
                    <div class="col-xl-6">
                        <div class="daterange-card">
                            ...
                            <p>
                                If you're using a date range as a filter, you may want to attach a picker to an input but
                                leave it empty by default. This example shows how to accomplish that using the
                                <code>autoUpdateInput</code> setting, and
                    ...
                    <div class="col-lg-12">
                        <div class="daterange-card">
                            ...
                            <p>
                                ...
                                minutes dropdown to e.g.
                                offer only 15-minute or 30-minute increments.
                            </p>
                            <div class="theme-form">
                                <div class="form-group">
                                    <input class="form-control digits" type="text" name="daterange2"
    ...
    @push('scripts')
        <script src="{{ asset('cms_assets/js/datepicker/daterange-picker/moment.min.js') }}"></script>
        <script src="{{ asset('cms_assets/js/datepicker/daterange-picker/daterangepicker.js') }}"></script>
        <script src="{{ asset('cms_assets/js/datepicker/daterange-picker/daterange-picker.custom.js') }}"></script>
    @endpush
@endsection
