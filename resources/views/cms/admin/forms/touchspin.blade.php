                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add <code>data-bts-postfix="POSTFIX_VALUE"</code> attribute to input to add postfix to
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add <code>data-bts-prefix="PREFIX_VALUE"</code> attribute to input to add prefix to
                                touchspin input group.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Use <code>data-bts-min="VALUE" data-bts-max="VALUE"</code> attribute to input to set min
                                and max value of touchspin input.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                                <div class="input-group">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add <code>data-bts-init-val="VALUE"</code> attribute attribute to set initial value for
                                input group.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add <code>data-bts-step="VALUE"</code> attribute for increament and decrement steps to
                                touchspin input group.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Use <code>data-bts-decimal="VALUE"</code> attribute to use decimal value of touchspin
                                input.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add <code>data-bts-button-down-class & data-bts-button-up-class</code> attribute to change
                                button Class.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Add icon class in <code>data-bts-postfix</code> attribute to icon to postfix as well
                                prefix.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Use <code>data-bts-button-down-txt & data-bts-button-up-txt</code> attribute to set
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Use <code>data-bts-prefix & data-bts-postfix</code> attribute to set Prefix and Postfix to
                                touchspin input with button.</span>
                        </div>
                        <div class="card-body">
                            <fieldset>
                                <div class="input-group">
                                        ...
                                        <div class="dropdown">
                                            <div class="btn-group mb-0 me-0">
                                                ...
                                                <div class="dropdown-content">
                                                    <a href="#">Action</a><a href="#">Another Action</a><a
