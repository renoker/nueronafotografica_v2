            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>
                            ...
                            default feedback tooltips, but still provides access to the form validation APIs in JavaScript.
                            Try to submit the form below; our JavaScript will intercept the submit button and relay feedback
                            to you.
                        </span>
                        <span>When attempting to submit, you’ll see the <code class="text-danger">:invalid </code> and <code
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>While these feedback styles cannot be styled with CSS, you can still customize the feedback
                            text through JavaScript.</span>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row g-3">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Tooltips</h5>
                        <span>
                            If your form layout allows it, you can swap the <code
                            ...
                            this already, but your project may
