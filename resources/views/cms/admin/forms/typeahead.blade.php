            ...
            <div class="row">
                            ...
                            <div id="the-basics">
                                <form class="theme-form">
                                    <div class="form-group">
                                        <input class="form-control typeahead form-control" type="text"
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Bloodhound offers advanced functionalities such as prefetching and backfilling with remote
                                data.</span>
                        </div>
                        <div class="card-body">
                            <div id="bloodhound">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h5>Remote</h5>
                            <span>Remote data is only used when the data provided by local and prefetch is
                                insufficient</span>
                        </div>
                        <div class="card-body">
                            <div id="remote">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="card">
                        <div class="card-header pb-0">
                            ...
                            <span>Two datasets that are prefetched, stored, and searched on the client. Highlighting is
                                enabled.</span>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="rtl-support">
                                <form class="theme-form">
                                    <div class="form-group">
                                        <input class="form-control typeahead form-control" type="text" dir="rtl"
                                            placeholder="Countries" />
                                    </div>
                                </form>
                            </div>
