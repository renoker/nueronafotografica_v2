                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group"><input class="form-control" type="text"
                                                placeholder="Recipient's username" aria-label="Recipient's username" /><span
                            ...
                            <div class="col">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label">Left & Right Addon</label>
                                        <div class="input-group mb-3">
                                            <span class="input-group-text"><i class="icon-zoom-out"> </i></span> <input
                                    ...
                                    <div class="mb-3 input-group-square">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="icofont icofont-credit-card">
                                                </i></span>
                                    ...
                                    <div>
                                        <label class="form-label">Left & Right Addon</label>
                                        <div class="input-group pill-input-group">
                                            <span class="input-group-text"><i class="icofont icofont-ui-copy"> </i></span>
                                            <input class="form-control" type="text"
                                                aria-label="Amount (to the nearest dollar)" />
                                            <span class="input-group-text"><i class="icofont icofont-stock-search">
                                                </i></span>
                                        </div>
                                    </div>
                                </form>
