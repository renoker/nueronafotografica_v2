                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" id="profile-tab" data-bs-toggle="tab" href="#profile"
                                        role="tab" aria-controls="profile" aria-selected="false">Action</a><a
                                        class="dropdown-item" href="#">Another action</a>
                                    <a class="dropdown-item" href="#">Something else here</a><a class="dropdown-item"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs nav-bottom" id="bottom-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="bottom-home-tab" data-bs-toggle="tab" href="#bottom-home"
                                    role="tab" aria-controls="bottom-home" aria-selected="true"><i
                                        class="icofont icofont-ui-home"></i>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-bottom-tab" data-bs-toggle="tab" href="#bottom-profile"
                                    role="tab" aria-controls="profile-icon" aria-selected="false"><i
                                        class="icofont icofont-man-in-glasses"></i>Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-bottom-tab" data-bs-toggle="tab" href="#bottom-contact"
                                    role="tab" aria-controls="contact-icon" aria-selected="false"><i
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs" id="icon-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-icon-tab" data-bs-toggle="tab" href="#contact-icon"
                                    role="tab" aria-controls="contact-icon" aria-selected="false"><i
                                        class="icofont icofont-contacts"></i>Contact</a>
                            </li>
                        </ul>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-right" id="right-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="right-home-tab" data-bs-toggle="tab" href="#right-home"
                                    role="tab" aria-controls="right-home" aria-selected="true"><i
                                        class="icofont icofont-ui-home"></i>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-right-tab" data-bs-toggle="tab" href="#right-profile"
                                    role="tab" aria-controls="profile-icon" aria-selected="false"><i
                                        class="icofont icofont-man-in-glasses"></i>Profile</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-right-tab" data-bs-toggle="tab" href="#right-contact"
                                    role="tab" aria-controls="contact-icon" aria-selected="false"><i
                                        class="icofont icofont-contacts"></i>Contact</a>
                            </li>
                        </ul>
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                        ...
                                        <p>
                                            ...
                                            versions of Lorem Ipsum. Lorem Ipsum has been the
                ...
                <div class="card height-equal">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills" id="pills-icontab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-iconhome-tab" data-bs-toggle="pill"
                                    href="#pills-iconhome" role="tab" aria-controls="pills-iconhome"
                                    aria-selected="true"><i class="icofont icofont-ui-home"></i>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-iconprofile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-iconcontact-tab" data-bs-toggle="pill"
                        ...
                        <div class="tab-content" id="pills-icontabContent">
                            <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel"
                                ...
                                <p class="mb-0 m-t-30">
                                    ...
                                    release of Letraset sheets containing Lorem Ipsum passages, and more recently with
                                    desktop publishing software like Aldus PageMaker including versions of Lorem IpsumIt was
                                    popularised in the 1960s with the
                                    release of Letraset sheets containing Lorem Ipsum passages, and more recently with
                                    desktop publish It was popularised in the 1960s with the release of Letraset sheets
            ...
            <div class="col-sm-12 col-xl-6 xl-100">
                <div class="card height-equal">
                    <div class="card-header pb-0">
                        ...
                        <span>Add <code>.nav-*</code> class with nav class</span><span>remove <code>nav-pill</code> class
                            from pill style Tab</span>
                    </div>
                    <div class="card-body">
                        <ul class="nav nav-dark" id="pills-darktab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-darkhome-tab" data-bs-toggle="pill"
                                    href="#pills-darkhome" role="tab" aria-controls="pills-darkhome"
                                    aria-selected="true"><i class="icofont icofont-ui-home"></i>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-darkprofile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-darkcontact-tab" data-bs-toggle="pill"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-tabs nav-primary" id="pills-warningtab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-warninghome-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-warningprofile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-warningcontact-tab" data-bs-toggle="pill"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills nav-secondary" id="pills-successtab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-successhome-tab" data-bs-toggle="pill"
                                    href="#pills-successhome" role="tab" aria-controls="pills-successhome"
                                    aria-selected="true">
                                    <i class="icofont icofont-ui-home"></i>Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-successprofile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-successcontact-tab" data-bs-toggle="pill"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills nav-info" id="pills-infotab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-infohome-tab" data-bs-toggle="pill"
                                    href="#pills-infohome" role="tab" aria-controls="pills-infohome"
                                    aria-selected="true"><i class="icofont icofont-ui-home"></i>Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-infoprofile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-infocontact-tab" data-bs-toggle="pill"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills nav-warning" id="pills-warning-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-warning-home-tab" data-bs-toggle="pill"
                                    href="#pills-warning-home" role="tab" aria-controls="pills-warning-home"
                                    aria-selected="true">
                                    <i class="icofont icofont-ui-home"></i>Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-warning-profile-tab" data-bs-toggle="pill"
                                    href="#pills-warning-profile" role="tab" aria-controls="pills-warning-profile"
                                    aria-selected="false">
                                    <i class="icofont icofont-man-in-glasses"></i>Profile
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-warning-contact-tab" data-bs-toggle="pill"
                                    href="#pills-warning-contact" role="tab" aria-controls="pills-warning-contact"
                                    aria-selected="false">
                                    <i class="icofont icofont-contacts"></i>Contact
                                </a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="nav nav-pills nav-danger" id="pills-danger-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-danger-home-tab" data-bs-toggle="pill"
                                    href="#pills-danger-home" role="tab" aria-controls="pills-danger-home"
                                    aria-selected="true">
                                    <i class="icofont icofont-ui-home"></i>Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-danger-profile-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="pills-danger-contact-tab" data-bs-toggle="pill"
