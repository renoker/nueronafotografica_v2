                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="onhover-dropdown navs-dropdown">
                            <button class="btn btn-primary onhover-dropdown">Dropdown example <i
                    ...
                    <div class="card-body">
                        <div class="border nav-list">
                            <ul class="nav-list-disc">
                                <li>
                                    <a href="javascript:void(0)"><i class="fa fa-angle-right"></i><span>
                                            Dashboard</span></a>
                                </li>
                                <li>
                        ...
                        <div class="onhover-dropdown navs-dropdown">
                            ...
                            <div class="onhover-show-div">
                                <ul class="icon-lists navs-icon">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="sidebar"></i><span>
                                                Sidebar</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="layout"></i><span> Page
                                                Layout</span></a>
                                    </li>
                                    <li class="pb-0">
                                        <a href="javascript:void(0)"><i data-feather="cloud-lightning"></i><span>
                                                Footers</span></a>
                                    </li>
                                    <li class="separator"></li>
                                    <li class="pt-0">
            ...
            <div class="col-lg-6">
                <div class="card height-equal">
                    ...
                    <div class="card-body">
                        <ul class="icon-lists border navs-icon">
                            <li>
                                <a class="active" href="javascript:void(0)"><i data-feather="home"></i><span>
                                        Dashboard</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><i data-feather="airplay"></i><span> Widgets</span></a>
                            ...
                            <li>
                                <a class="disabled" href="javascript:void(0)"><i data-feather="box"></i><span>
                                        Base</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><i data-feather="file-text"></i><span> Forms</span></a>
                            ...
                            <li>
                                <a class="disabled" href="javascript:void(0)"><i data-feather="sliders"></i><span>
                                        Timeline</span></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0)"><i data-feather="git-pull-request"></i><span>
                                        Editors</span></a>
                            </li>
                        </ul>
                        <div class="onhover-dropdown navs-dropdown">
                            ...
                            <div class="onhover-show-div">
                                <ul class="icon-lists navs-icon">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="airplay"></i><span>
                                                Widgets</span></a>
                                    </li>
                                    <li>
                                        <a class="disabled" href="javascript:void(0)"><i data-feather="box"></i><span>
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="file-text"></i><span>
                                                Forms</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="server"></i><span> Tables</span></a>
                                    ...
                                    <li>
                                        <a class="disabled" href="javascript:void(0)"><i
                                                data-feather="sliders"></i><span> Timeline</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="bar-chart"></i><span>
                                                Charts</span></a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="map"></i><span> Maps</span></a>
                    ...
                    <div class="card-body">
                        <ul class="icon-lists border navs-icon inline-nav">
                            ...
                            <li class="pl-navs-inline">
                                <a href="javascript:void(0)"><i class="fa fa-angle-right"></i><span> State
                                        Color</span></a>
                            </li>
                            <li class="pl-navs-inline">
                            ...
                            <li class="pl-navs-inline">
                                <a href="javascript:void(0)"><i class="fa fa-angle-right"></i><span> Tags &
                                        Pills</span></a>
                            </li>
                            <li class="pl-navs-inline">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <ul class="icon-lists border navs-icon">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)"><i data-feather="folder-plus"></i><span>
                                                Advance</span></a>
                                        <ul>
                                            <li class="pl-navs-inline">
                                                <a href="javascript:void(0)"><i
                                                        class="fa fa-angle-right"></i>Scrollable</a>
                                            </li>
                                            <li class="pl-navs-inline">
                                                <a href="javascript:void(0)"><i class="fa fa-angle-right"></i>Tree
                                                    View</a>
                                            </li>
                                            <li class="pl-navs-inline">
                            ...
                            <div class="col-lg-6 nav-md-mt">
                                ...
                                <ul class="icon-lists border navs-icon default-according style-1" id="accordionoc">
                                    ...
                                    <li>
                                        <button class="btn btn-link text-muted active" data-bs-toggle="collapse"
                                            data-bs-target="#collapseicon" aria-expanded="true"><i
                                                data-feather="folder-plus"></i><span> Advance</span></button>
                                        <ul class="collapse show" id="collapseicon" aria-labelledby="collapseicon"
                                    ...
                                    <li>
                                        <button class="btn btn-link text-muted collapsed pb-0" data-bs-toggle="collapse"
                                            data-bs-target="#collapseicon1" aria-expanded="false"><i
                                                data-feather="server"></i> Tables</button>
