                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use <code>.btn-pill</code> class to button for Round
                                                        Buttons.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use <code>.dropdown-toggle</code> class to button for
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use <code>btn-group</code> class to button for
                                                        <code>div</code>.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <div class="alert alert-primary">
                                                        <p class="font-light"><strong>Success!</strong> Indicates a
                                                    ...
                                                    <p>
                                                        <span>
                                                            ...
                                                            optional dismiss button. Add <code> alert
                                                                alert-primary</code>,<code> alert alert-secondary</code>,
                                                            <code> alert alert-success</code>,<code> alert alert-info</code>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="alert alert-primary">
                                                        <p class="font-light"><strong>Success!</strong> You should <a
                                                                class="alert-link" href="javascript:void(0)">read this
                                                                message</a>.</p>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="alert alert-secondary alert-dismissible fade show"
                                                        role="alert">
                                                        <p class="font-light"><strong>Holy !</strong> You can check in on
                                                            some of those fields below.</p>
                                                ...
                                                <td>
                                                    <span>
                                                        Add a dismiss button and the<code> alert
                                                        ...
                                                        dismiss button,
                                                        add the data-bs-dismiss="alert" attribute, which triggers the
                                                        JavaScript functionality. Be sure to use the<code>a</code>element
                                                        with it for proper behavior across all devices. To animate
                                                        alerts when dismissing them, be sure to add the .fade and .in
                                                        classes.
                                                    </span>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table table-bordered checkbox-td-width">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Uses a progress bar with class<code>progress-bar</code> and
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Uses a gradient to create a striped effect
                                                        class.<code>progress-bar-striped</code></span>
                                                </td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table class="table table-bordered checkbox-td-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Wrap with use<code>checkbox-solid-*</code>,<code>primary,
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Wrap with use<code>disabled</code>,<code>primary, secondary,
                                    ...
                                    <table class="table table-bordered radio-first-col-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Wrap with use <code>.radio-*</code> and color
                                                        <code>.radio-*</code><code>primary , secondary , success ,
                                                            info</code> on Radio.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Checked Radio</td>
                                    ...
                                    <table class="table table-bordered checkbox-td-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control form-control-lg mb-10"
                                                    ...
                                                    <select class="form-control form-control-sm mt-5 mb-10"
                                                ...
                                                <td>
                                                    <span>Use for large and small select control add
                                                        class<code>form-control-*</code><code>lg, sm</code>.</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use for multi select control add code <code>multiple</code>on
                                                        select.</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="table table-bordered checkbox-td-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use for basic input color add
                                                        class<code>input-air-*</code><code>primary, secondary, success,
                                                            info</code>.on input</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        Use the <code>.badge</code> class, followed by. with badge color use
                                                        class <code>.badge-*</code><code>primary , secondary , success ,
                                                            info, warning, danger, light</code> class within
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50 m-5">
                                                    <div class="badge badge-primary label-square"><i
                                                            class="fa fa-paperclip fa-lg p-r-5"></i><span
                                                            class="f-14">Primary Label</span></div>
                                                </td>
                                                <td>
                                                    <span>Use the <code>label-square</code> class with
                                                        <code>div</code></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Link</td>
                                                <td class="w-50"><a class="btn btn-primary" href="javascript:void(0)"
                                                        data-bs-toggle="tooltip" title="" role="button"
                                                        data-original-title="Hooray!">Link</a></td>
                                                <td>
                                                    <span>Use <code>a href="javascript:void(0)"</code> for link trigger.
                                                        This is a link trigger</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use <code>btn btn-outline-info</code> for outline trigger. and
                                                        button bold Border use class<code>btn
                                                            btn-outline-dark-2x</code></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="w-50">
                                                    <label class="switch"> <input type="checkbox" disabled="" /><span
                                                            class="switch-state"></span> </label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>Use class <code>bg-*</code><code>Primary , Secondary , Success ,
                                                            Info , Warning , Danger</code>in span with icon show switch
                                                        <code>icon-state</code>on div.</span>
                                                </td>
                                            </tr>
                                            <tr>
