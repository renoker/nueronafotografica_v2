                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar left-bookmark">
                                        ...
                                        <ul class="nav main-menu contact-options" role="tablist">
                                            ...
                                            <li>
                                                <a id="pills-personal-tab" data-bs-toggle="pill" href="#pills-personal"
                                            ...
                                            <li>
                                                <a class="show" id="pills-organization-tab" data-bs-toggle="pill"
                                                ...
                                                <div class="row list-persons" id="addcon">
                                                    <div class="col-xl-4 xl-50 col-md-5 box-col-6">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab"
                                                            ...
                                                            <a class="contact-tab-3 nav-link" id="v-pills-settings-tab"
                                                            ...
                                                            <a class="contact-tab-4 nav-link" id="v-pills-contact1-tab"
                                                            ...
                                                            <a class="contact-tab-5 nav-link" id="v-pills-contact8-tab"
                                                            ...
                                                            <a class="contact-tab-6 nav-link" id="v-pills-contact3-tab"
                                                            ...
                                                            <form>
                                                                ...
                                                                <div class="row g-2 more-data">
                                                                    ...
                                                                    <div class="mt-0 mb-3 col-md-12">
                                                                        ...
                                                                        <div class="d-block">
                                                                            <label class="me-3" for="edo-ani"> <input
                                                                                    class="radio_animated" id="edo-ani"
                                                                                    type="radio" name="rdo-ani"
                                                                                    checked="" /><span>Male</span>
                                                                            </label>
                                                                            <label for="edo-ani1"> <input
                                                                                    class="radio_animated" id="edo-ani1"
                                                                                    type="radio"
                                                                ...
                                                                <a class="ps-0 edit-information f-w-600"
                                                ...
                                                <div class="row list-persons">
                                                    <div class="col-xl-4 xl-50 col-md-5 box-col-6">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab1"
                                                            role="tablist" aria-orientation="vertical">
                                                            <a class="nav-link active" id="v-pills-iduser-tab"
                                                            ...
                                                            <a class="nav-link" id="v-pills-iduser1-tab"
                                                            ...
                                                            <a class="nav-link" id="v-pills-iduser2-tab"
                                                            ...
                                                            <a class="nav-link" id="v-pills-iduser3-tab"
                                        ...
                                        <div class="modal-header p-l-20 p-r-20">
                                            <h6 class="modal-title w-100">
                                                ...
                                                <span class="pull-right">
                                                    <a class="closehistory" href="javascript:void(0)"><i
