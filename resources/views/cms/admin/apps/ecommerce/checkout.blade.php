                    ...
                    <div class="col-xl-6 col-sm-12">
                        <div class="checkout-details">
                            <div class="order-box">
                                    ...
                                    <li class="shipping-class">
                                        ...
                                        <div class="shopping-checkout-option">
                                            <label class="d-block" for="chk-ani"> <input class="checkbox_animated"
                                                    id="chk-ani" type="checkbox" checked="" />Option 1 </label>
                                            <label class="d-block" for="chk-ani1"> <input class="checkbox_animated"
                                                    id="chk-ani1" type="checkbox" />Option 2 </label>
                                        </div>
                                    </li>
                                </ul>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label class="d-block" for="edo-ani"> <input class="radio_animated"
                                                    id="edo-ani" type="radio" name="rdo-ani" checked=""
                                                    data-original-title="" title="" />Check Payments </label>
                                            <label class="d-block" for="edo-ani1"> <input class="radio_animated"
                                                    id="edo-ani1" type="radio" name="rdo-ani" data-original-title=""
                                                    title="" />Cash On Delivery </label>
                                ...
                                <div class="order-place"><a class="btn btn-primary" href="javascript:void(0)">Place Order
                                    </a></div>
                            </div>
                        </div>
                    </div>
