                            ...
                            <div class="row invo-profile">
                                ...
                                <div class="col-xl-8">
                                    <div class="text-xl-end" id="project">
                                        ...
                                        <p>
                                            Lorem Ipsum is simply dummy text of the printing and typesetting industry.It is
                            ...
                            <div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-8">
                                        <div>
                                            <p class="legal">
                                                <strong>Thank you for your business!</strong> Payment is expected within 31
                                                days; please process this invoice within that time. There will be a 5%
