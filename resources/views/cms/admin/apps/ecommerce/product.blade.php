...
@section('content')
                ...
                <div class="row m-b-10">
                    <div class="col-md-3 col-sm-2 products-total">
                        <div class="square-product-setting d-inline-block">
                            <a class="icon-grid grid-layout-view" href="javascript:void(0)" data-original-title=""
                                title=""><i data-feather="grid"></i></a>
                        </div>
                        <div class="square-product-setting d-inline-block">
                            <a class="icon-grid m-0 list-layout-view" href="javascript:void(0)" data-original-title=""
                        ...
                        <div class="grid-options d-inline-block">
                            <ul>
                                <li>
                                    <a class="product-2-layout-view" href="javascript:void(0)" data-original-title=""
                                        title=""><span class="line-grid line-grid-1 bg-primary"></span><span
                                            class="line-grid line-grid-2 bg-primary"></span></a>
                                </li>
                                <li>
                                    <a class="product-3-layout-view" href="javascript:void(0)" data-original-title=""
                                        title="">
                                ...
                                <li>
                                    <a class="product-4-layout-view" href="javascript:void(0)" data-original-title=""
                                        title="">
                                ...
                                <li>
                                    <a class="product-6-layout-view" href="javascript:void(0)" data-original-title=""
                                        title="">
                                            ...
                                            <div class="card-body filter-cards-view animate-chk">
                                                <div class="product-filter">
                                                    ...
                                                    <div class="checkbox-animated mt-0">
                                                        <label class="d-block" for="edo-ani5"> <input class="radio_animated"
                                                                id="edo-ani5" type="radio" data-original-title=""
                                                                title="" />Man Shirt </label>
                                                        <label class="d-block" for="edo-ani6"> <input class="radio_animated"
                                                                id="edo-ani6" type="radio" data-original-title=""
                                                                title="" />Man Jeans </label>
                                                        <label class="d-block" for="edo-ani7"> <input
                                                                class="radio_animated" id="edo-ani7" type="radio"
                                                                data-original-title="" title="" />Woman Top </label>
                                                        <label class="d-block" for="edo-ani8"> <input
                                                                class="radio_animated" id="edo-ani8" type="radio"
                                                                data-original-title="" title="" />Woman Jeans
                                                        </label>
                                                        <label class="d-block" for="edo-ani9"> <input
                                                ...
                                                <div class="product-filter">
                                                    ...
                                                    <div class="checkbox-animated mt-0">
                                                        <label class="d-block" for="chk-ani"> <input
                                                                ...
                                                                data-original-title="" title="" /> Levi's </label>
                                                        <label class="d-block" for="chk-ani1"> <input
                                                                class="checkbox_animated" id="chk-ani1" type="checkbox"
                                                                data-original-title="" title="" />Diesel </label>
                                                        <label class="d-block" for="chk-ani2"> <input
                                                                class="checkbox_animated" id="chk-ani2" type="checkbox"
                                                                data-original-title="" title="" />Lee </label>
                                                        <label class="d-block" for="chk-ani3"> <input
                                                                class="checkbox_animated" id="chk-ani3" type="checkbox"
                                                                data-original-title="" title="" />Hudson </label>
                                                        <label class="d-block" for="chk-ani4"> <input
                                                                class="checkbox_animated" id="chk-ani4" type="checkbox"
                                                                data-original-title="" title="" />Denizen </label>
                                                        <label class="d-block" for="chk-ani5"> <input
                                                                class="checkbox_animated" id="chk-ani5" type="checkbox"
                                                                data-original-title="" title="" />Spykar </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-filter text-center"><img
                                                        ...
                                                        src="{{ asset('cms_assets/images/ecommerce/banner.jpg') }}"
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    <img class="img-fluid" src="{{ asset('cms_assets/images/ecommerce/01.jpg') }}"
                                        alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter16"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-qnty">
                                                            ...
                                                            <div class="addcart-btn"><a class="btn btn-primary me-3"
                                                                    href="cart">Add to Cart </a><a
                                                                    class="btn btn-primary" href="product-page">View
                                                                    Details</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    ...
                                    <img class="img-fluid" src="{{ asset('cms_assets/images/ecommerce/02.jpg') }}"
                                        alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter1"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-xl-3 col-sm-6 xl-4">
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    <img class="img-fluid" src="{{ asset('cms_assets/images/ecommerce/03.jpg') }}"
                                        alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter2"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    ...
                                    <img class="img-fluid" src="{{ asset('cms_assets/images/ecommerce/04.jpg') }}"
                                        alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter3"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter4"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter5"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter6"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter7"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter8"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter9"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter10"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter11"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter12"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter13"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter14"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="product-img">
                                    ...
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <a data-bs-toggle="modal" data-bs-target="#exampleModalCenter15"><i
                                                        class="icon-eye"></i></a>
                                            </li>
                                        </ul>
                                    </div>
    ...
    @push('scripts')
        ...
        <script src="{{ asset('cms_assets/js/product-tab.js') }}"></script>
    @endpush
@endsection
