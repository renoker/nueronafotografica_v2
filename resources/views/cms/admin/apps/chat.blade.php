                                    ...
                                    <div class="search">
                                        <form class="theme-form">
                                            <div class="form-group"><input class="form-control" type="text"
                                                    placeholder="search" /><i class="fa fa-search"></i></div>
                                        </form>
                                    </div>
                        ...
                        <div class="row chat-box">
                                            ...
                                            <li>
                                                <div class="message my-message">
                                                    ...
                                                    <div class="message-data text-end"><span
                                                            class="message-data-time">10:12 am</span></div>
                                            ...
                                            <li class="clearfix">
                                                <div class="message other-message pull-right">
                                                    <img class="rounded-circle float-end chat-user-img img-30"
                                                        src="{{ asset('cms_assets/images/user/12.png') }}"
                                                        alt="" />
                            ...
                            <div class="col chat-menu">
                                <ul class="nav nav-tabs border-tab nav-primary" id="info-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="contact-info-tab" data-bs-toggle="tab"
                                ...
                                <div class="tab-content" id="info-tabContent">
                                                    ...
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="about">
                                                                <div class="name">Kori Thomas</div>
                                                                <div class="status"><i
                                                                        class="fa fa-reply font-danger"></i> 1 Feb, 6:56 PM
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="info-profile" role="tabpanel"
                                        ...
                                        <div class="status">
                                            ...
                                            <hr />
                                            <p>Established fact that a reader will be distracted <i
                                                    class="icofont icofont-emo-heart-eyes font-danger f-20"></i><i
                                                    class="icofont icofont-emo-heart-eyes font-danger f-20 m-l-5"></i></p>
                                            <hr />
