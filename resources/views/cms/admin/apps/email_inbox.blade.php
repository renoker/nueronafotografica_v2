                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar">
                                        ...
                                        <ul class="nav main-menu" role="tablist">
                                            <li class="nav-item">
                                                <a class="btn-primary btn-block btn-mail w-100" id="pills-darkhome-tab"
                                ...
                                <div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu"
                                                                ...
                                                                <a class="dropdown-item" href="javascript:void(0)">Move to
                                                                    ...
                                                                    href="javascript:void(0)">Move to trush </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="inbox">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>Dee Deo</h6>
                                                <p>Popular belief, Lorem Ipsum is not simply random text. It has roots in a
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>Peg Legge</h6>
                                                <p>A Latin professor at Hampden-Sydney College in Virginia, looked up one of
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>Olive Yew</h6>
                                                <p>Looked up one of the more obscure Latin words, consectetur, from a Lorem
                                                    Ipsum passage.</p>
                                                <span>05:59 AM</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>Hugo First</h6>
                                                <p>Randomised words which don't look even slightly believable. If you are
