                        ...
                        <div>
                            <div class="line">
                                <p>
                                    ...
                                    <strong>data-wow-offset: </strong>Distance to start the animation (related to the
                                    browser bottom)<br />
                    ...
                    <div class="card-body">
                        <div>
                            <div class="line">
                                ...
                                <p>
                                    <strong>offset: </strong>Define the distance between the bottom of browser viewport and
                                    the top of hidden box.<br />
