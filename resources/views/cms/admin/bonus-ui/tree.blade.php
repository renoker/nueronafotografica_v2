...
@push('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('cms_assets/css/tree.css') }}">
@endpush
...
@section('content')
                                                ...
                                                <li data-jstree='{"opened":true}'>
                                                    ...
                                                    <ul>
                                                        <li data-jstree='{"opened":false}'>
                                                            Sub Child
                                                            <ul>
                                                                <li data-jstree='{"selected":false,"type":"file"}'>Sub File
                                                                </li>
    ...
    @push('scripts')
        <script src="{{ asset('cms_assets/js/tree/jstree.min.js') }}"></script>
        <script src="{{ asset('cms_assets/js/tree/tree.js') }}"></script>
    @endpush
@endsection
