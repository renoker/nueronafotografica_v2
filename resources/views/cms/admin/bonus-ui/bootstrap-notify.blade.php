                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-url"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-dismiss"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-pause"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-top"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-title"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 col-6">
                                            <div class="media-body text-start icon-state">
                                                <label class="switch"> <input id="bootstrap-notify-progress"
                                                        type="checkbox" /><span class="switch-state"></span> </label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <span>Click Display Notify button to show different notify demo's & display script of
                                    different Notify demo below</span>
