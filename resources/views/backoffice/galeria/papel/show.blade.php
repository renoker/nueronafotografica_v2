                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="paper_es" value="{{ $row->paper_es }}"
                                                type="text" placeholder="Papel Español" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="paper_en" value="{{ $row->paper_en }}"
                                                type="text" placeholder="Papel Ingles" />
                                        </div>
                                    </div>
                                </div>
                            </div>
