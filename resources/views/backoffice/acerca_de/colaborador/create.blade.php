                    ...
                    <form class="form theme-form" action="{{ route($rutaStore) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label">Imagen colabodador <br> (607 X 878px)</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label" for="exampleFormControlSelect7">Lado</label>
                                        <div class="col-sm-9">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control" name="name_es" type="text"
                                                placeholder="Nombre" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="description_es" rows="5" cols="5" placeholder="Descripción"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="card-header pb-0 pt-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <label class="col-sm-3 col-form-label">Descripción</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" name="description_en" rows="5" cols="5" placeholder="Descripción"></textarea>
                                </div>
                            </div>
                        </div>
