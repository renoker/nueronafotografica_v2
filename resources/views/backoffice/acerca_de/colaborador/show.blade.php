                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-select digits" id="exampleFormControlSelect7" name="lugar">
                                            <option value="1" @if ($row->lugar == 1) selected @endif>
                                                Izquierdo</option>
                                            <option value="2" @if ($row->lugar == 2) selected @endif>Derecho
                                            </option>
                                        </select>
                                    </div>
                                </div>
